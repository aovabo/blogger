...
Should you have any questions, you may directly contact ovabor Labs by sending an email to [us.](mailto:legal@ovabor.com)
...
Please note that when you use Priva Check, we use Google data for authentication purposes and to identify companies holding your data. The data used includes email subject lines and metadata. We do not read your emails.
